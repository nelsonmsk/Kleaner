...
class AppDefaults extends Model
{
	...
	protected $fillable = ['companyName','appTitle','introText','brandHeading','aboutText','introVideo','facebook','twitter','instagram','googleplus','youtube','linkedin','whatsapp','phone','email','address','contactText','username'];
