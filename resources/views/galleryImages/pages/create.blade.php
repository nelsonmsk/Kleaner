...
<div class="col-lg-8 col-md-10 col-md-offset-2">
    <div class="card">
		...
		@else
			<h2><span class="card-category">{{ __('Upload Profile Image') }} </span></h2>			
		@endif
		</div>
		...
		<div class="card-body">	
			...
			@else
				<div class="form-group hidden">  
				  ...
				  <label for="ref_class" class="col-sm-2 control-label">Ref Class:</label>
					<div class="col-sm-10">
					  <input id="ref_class" type="text"  class="form-control" name="ref_class" value="{{'Profiles'}}" required />
					</div>
				</div>
				<div class="form-group hidden">     
				  <label for="ref_id" class="col-sm-2 control-label">Ref Id:</label>
					<div class="col-sm-10">
					  <input id="ref_id" type="text"  class="form-control" name="ref_id" value="{{Auth::user()->id}}" required />
					</div>
				</div>					
			@endif
				<div class="form-group">
