					...
					<div class="row">
								...
								<div class="row">
									<div class="col-md-12 step-details">
										<div class="card card-profile">
												...
												@else
													<a href="javascript:void(0)">
														<img class="img-round" src=" {{url('/images/features/p1.jpg')}}" />
													</a>
												@endif
												</div>
						...
						<div class="col-md-4 step-img">
							<div class="row">
									  ...
									  <div class="card">
											  <span class="prof-txt text-left"><strong>{{__('Name:  ')}}</strong><span class="card-description"> {{ $profile->name }}</span></span>
											  <span class="prof-txt text-left"><strong>{{__('Phone:  ')}}</strong><span class="card-description"> {{ $profile->phone }}</span></span>									 
											  <span class="prof-txt text-left"><strong>{{__('Email:  ')}}</strong><span class="card-description"> {{ $profile->email }}</span></span>
											  <span class="prof-txt text-left"><strong>{{__('Address:  ')}}</strong><span class="card-description"> {{ $profile->address }}</span></span>								  
									  </div>
