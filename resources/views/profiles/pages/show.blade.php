								...
								<div class="row">
									<div class="col-md-12 step-details">
										<div class="card card-profile">
												...
												@else
													<a href="javascript:void(0)">
														<img class="img-round" src=" {{url('/img/c1.jpg')}}" />
													</a>
												@endif
												</div>
						...
						<div class="col-md-4 step-img">
							<div class="row">
									  ...
									  <div class="card">
											  ...
											  <span class="prof-txt text-left"><strong>{{_('Address:  ')}}</strong><span class="card-description"> {{ $profile->address }}</span></span><hr/>
											  <span class="prof-txt text-left"><strong>{{_('Created:  ')}}</strong><span class="card-description"> {{ $profile->created_at }}</span></span>
											  <span class="prof-txt text-left"><strong>{{_('Modified:  ')}}</strong><span class="card-description"> {{ $profile->updated_at }}</span></span>											  
									  </div>
