...
@section('body')
  ...
  <div class="col-lg-8 col-md-10 col-md-offset-2">
    ...
    <h2><span class="card-category">{{ __('Add ServiceCategory') }} </span> 
	<a href="{{config('app.url')}}/serviceCategories" class="btn btn-secondary pull-right">View All</a></h2>
    </div>
	
<div class="card-body">	
    <form class="form-horizontal singleForm" id="serviceCategories-form1" method="post" action="serviceCategories" data-parsley-validate>
